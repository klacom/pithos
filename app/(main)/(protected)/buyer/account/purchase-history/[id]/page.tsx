    ...
    const handleDownloadInvoice = async () => {
        ...
        try {
            ...
            const invoiceContent = [
                ...
                "",
                `Product: ${transaction.products?.product_name || transaction.products?.name || "Unknown Product"}`,
                `Seller: ${transaction.products?.seller_owner_id?.user_fullname || transaction.products?.seller_owner_id?.user_email || "Unknown Seller"}`,
                `Amount Paid: ${formatPrice(transaction.products?.price || 0)}`,
                "",
                "This invoice is generated by Pithos.",
            ].join("\n");

            const blob = new Blob([invoiceContent], {
                type: "application/vnd.oasis.opendocument.text",
            });
            const fileName = `invoice-${transaction.transaction_id}.odf`;
