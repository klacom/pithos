...
import { ArrowLeft, Sparkles, ShieldCheck, FileText, Users, Handshake, Loader2 } from "lucide-react";
import Link from "next/link";
import Footer from "@/components/main-components/footer/Footer";
import { createClient } from "@/lib/supabase/client";
import { useState, useEffect } from "react";
import { becomeSeller } from "../become-seller-actions";
                            ...
                            userRole === "seller" ? (
                                <div className="text-center space-y-4">
                                    ...
                                    <Button asChild size="lg" variant="red_default">
                                        <Link href="/seller/seller-dashboard">Go to Dashboard</Link>
                                    </Button>
                                </div>
                            ) : (
                                <div className="text-center space-y-4">
                                    <p className="text-muted-foreground">Ready to switch from Buyer to Seller?</p>
                                    <Button
                                        size="lg"
                                        variant="red_default"
