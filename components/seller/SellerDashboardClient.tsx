    ...
    return (
        <div className="flex flex-col p-4 bg-background w-full gap-4">
            ...
            <div className="flex gap-4 w-full flex-col lg:flex-row min-h-[260px]">
                ...
                {/* Recent Assets */}
                <div className="w-full bg-card border border-muted rounded-xl p-4 flex flex-col min-h-[200px]">
            ...
            {/* LOWER SECTION */}
            <div className="flex gap-4 w-full flex-col min-h-[320px] lg:overflow-hidden">

                {/* Line Chart */}
                <div className="flex-1 min-w-0 bg-card border border-muted rounded-xl p-4 flex flex-col gap-4 lg:h-[320px]">
                ...
                <div className="w-full shrink-0 flex flex-row gap-4">
